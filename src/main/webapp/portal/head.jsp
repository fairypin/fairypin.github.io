    ...
    <body class="easyui-layout">
        <div data-options="region:'north'" style="height:55px;border:none">
            ...
            <div class="easyui-panel navigation">
                <a href="/iwherecloud/portal/base.jsp" class="easyui-linkbutton" data-options="plain:true">首页</a>
                ...
                <a href="/iwherecloud/portal/about.jsp" class="easyui-linkbutton" data-options="plain:true">关于</a>
            </div>
