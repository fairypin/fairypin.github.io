 ...
 <div class="easyui-layout" style="width:900px;height:100%;margin: 0px auto;">
        <div data-options="region:'north'" style="height:350px;border: none;">
            <div id="slider">
              ...
              <ul>
                <li style="background: url('../img/about/G-BDLink.png') no-repeat center;background-size: contain;"></li>
                <li style="background: url('../img/about/G-BDGIS.png') no-repeat center;background-size: contain;"></li>
                <li style="background: url('../img/about/G-BDRS.png') no-repeat center;background-size: contain;"></li>
                <li style="background: url('../img/about/G-BDEarth.png') no-repeat center;background-size: contain;"></li>
                <li style="background: url('../img/about/G-BDSpatial.png') no-repeat center;background-size: contain;"></li>
              </ul>  
            </div>
        </div>
